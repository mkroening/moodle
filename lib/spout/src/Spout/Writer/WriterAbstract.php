...
abstract class WriterAbstract implements WriterInterface
{
    ...
    public function openToBrowser($outputFileName)
    {
        ...
        $this->globalFunctionsHelper->header('Content-Disposition: attachment; filename="' . clean_param($this->outputFilePath, PARAM_ASCII) . "\"; filename*=UTF-8''" . rawurlencode($this->outputFilePath));
